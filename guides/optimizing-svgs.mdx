...
You can also optimize SVG files directly from the editor context menu:

<Steps>
  <Step title="Right-click the SVG file">
    Right-click anywhere in an open SVG file editor.
  </Step>
  
  <Step title="Select 'Optimize SVG'">
    Choose the "Optimize SVG" option from the context menu.
  </Step>
